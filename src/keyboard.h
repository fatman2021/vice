...
typedef void (*key_alarm_func_t)(void);
extern int keyboard_restore_pressed(key_alarm_func_t kaf);
extern int keyboard_restore_released(key_alarm_func_t kaf);
extern int keyboard_do_key_pressed_matrix(int row, int column, key_alarm_func_t kaf);
extern int keyboard_do_key_released_matrix(int row, int column, key_alarm_func_t kaf);
