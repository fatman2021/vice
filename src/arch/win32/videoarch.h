...
extern int video_canvas_overlay_create_dx9(video_canvas_t *canvas, unsigned long index, int w, int h, int x, int y, const unsigned char *data);
extern int video_canvas_overlay_delete_dx9(video_canvas_t *canvas, unsigned long index);
extern int video_canvas_overlay_move_dx9(video_canvas_t *canvas, unsigned long index, int x, int y);
