...
typedef BOOL (APIENTRY *PFN_RPSetCrashReporter)(LPCWSTR pszAppName, LPCWSTR pszAppShortName, LPCWSTR pszAppVersion, LPCWSTR pszCrashDumpPath);
typedef BOOL (APIENTRY *PFN_RPSetCrashReporterA)(LPCSTR pszAppName, LPCSTR pszAppShortName, LPCSTR pszAppVersion, LPCSTR pszCrashDumpPath);
