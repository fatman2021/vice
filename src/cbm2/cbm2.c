...
int machine_specific_init(void)
{
    ...
    kbdbuf_init(939, 209, 10, (CLOCK)(8 * machine_timing.rfsh_per_sec * machine_timing.cycles_per_rfsh)); /* added 8* multiplier: minimum required for the the -keybuf command line option to work */
